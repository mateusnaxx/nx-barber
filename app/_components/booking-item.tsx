        ...
        <Sheet>
            ...
            <SheetContent className="px-0">
                ...
                <div className="px-5">
                    ...
                    <Badge variant={isBookingConfirmed ? "secondary" : "default"} className="w-fit my-3">
                    ...
                    <Card>
                        <CardContent className="p-3 gap-3 flex flex-col">
                            ...
                            <div className="flex justify-between">
                                ...
                                <h4 className="font-sm text-sm">{booking.barbershop.name}</h4>
                            </div>

                            <div className="flex justify-between">
                                <h3 className="font-sm text-gray-400">Data</h3>
                                <h4 className="font-sm text-sm">
                                    {format(booking.date, "dd", { locale: ptBR }) + " de "}
